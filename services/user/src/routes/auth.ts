...
import {/* ProfAccountInfo, accountInfo, accountSingleInfo,*/ changePassword, corperateReg, deleteUsers, login, passwordChange, register, registerStepThree, registerStepTwo, sendOtp, swithAccount, updateFcmToken, /*updateProfessional*/ updateProfile, upload_avatar, verifyBvnDetail, verifyMyBvn, verifyOtp } from '../controllers/auth';
